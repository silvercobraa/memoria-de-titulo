...
La tabla\ref{visionerrors} indica los facelet específicos donde el algoritmo de visión desarrollado se equivocó. En cada fila de dicha tabla, el string superior es el resultado obtenido y el inferior el esperado. Las diferencias se muestran subrayadas.
\begin{table}[h!]
	\centering
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|r|r|l|}
			...
			ID & Errores & Detalle \\ \hline\hline
			 ...
			 2 & 7 & BFFRURRULF\underline{\textbf{U}}URR\underline{\textbf{D}}F\underline{\textbf{U}}UBF\underline{\textbf{U}}\underline{\textbf{U}}FBLURDB\underline{\textbf{D}}LDLDRBRF\underline{\textbf{U}}BLFRUBLLUBBLL\underline{\textbf{F}}F \\
...
\begin{figure}[h!]
	...
	\includegraphics[width=0.70\textwidth]{figures/rg}
	}%
	\vfill
	\subcaptionbox{Proyección en ejes rojo (horizontal) y azul (vertical).}{%
	\includegraphics[width=0.70\textwidth]{figures/rb}
	}%
	\vfill
	\subcaptionbox{Proyección en ejes verde (horizontal) y azul (vertical).}{%
	\includegraphics[width=0.70\textwidth]{figures/gb}
	}%
